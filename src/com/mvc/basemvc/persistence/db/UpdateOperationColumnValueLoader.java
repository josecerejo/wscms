...
/**
 * @Description 更新操作数据库字段操作类，框架内部使用,不要在框架外部调用
 * @ClassName UpdateOperationColumnValueLoader
 * @author wjz_home@163.com
 * @Created 2013 2013-8-5 下午04:28:18
 */
public class UpdateOperationColumnValueLoader extends ColumnValueLoader {
